...
The code below is very repetitive so should not be seen as an example of good coding. It was just the fasteest way to get some graphs to show to Mark. I'll work on streamlining the code.
